...
public class UpdateProduct extends HttpServlet {
    ...
    public void doPost(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        String path = "D:/finaljava/e_commerce/web/images/";
        ...
        String UploadPath = "D:/finaljava/e_commerce/web/images/" + NewImgFileName;
        ...
        try {
            ...
            Connection conn = DriverManager.getConnection("jdbc:mysql://localhost:3307/e_commerce", "root", "Rushik@20");
